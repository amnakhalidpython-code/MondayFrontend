...
const CreateAccountEleven = () => {
  ...
  const toggleWidget = (widget) => {
    const updated = { ...selectedWidgets, [widget]: !selectedWidgets[widget] };
    setSelectedWidgets(updated);
    setBoardData(prev => ({ ...prev, selectedWidgets: updated }));
  };
      ...
      <div className="bg-white w-full h-full overflow-hidden shadow-2xl flex relative">
        ...
        <div className="w-1/2 flex flex-col justify-between bg-white">
          ...
          <div className="sticky bottom-0 px-20 py-6 flex justify-between items-center bg-white ">
            <Link to={userCategory === 'ngo' || userCategory === 'nonprofit' ? '/eight' : '/ten'}>
        ...
        <div className="w-1/2 bg-[#eceff8] flex items-center" style={{ contain: 'strict' }}>
          <div className="bg-white w-full h-[650px] ml-16 flex flex-col" style={{ filter: 'drop-shadow(0px 6px 20px rgba(0, 0, 0, 0.2))', borderTopLeftRadius: '16px', borderBottomLeftRadius: '16px' }}>
            <div className=" pt-4 pb-4">
              <h1 className="text-[24px] font-medium text-[#676879] leading-[30px] tracking-[-0.1px] ml-6" style={{ fontFamily: 'Poppins, Roboto, sans-serif' }}>Project overview</h1>
            </div>
            ...
            {hasAnySelected && (
              <div className="px-6 pb-4 bg-[#f6f7fb] flex-1 overflow-y-auto">
                <div className="p-2">
                  <div className="grid grid-cols-4 gap-4 mb-4">
                    <div className={`bg-white border border-[#d0d4e4] rounded-lg p-4 flex flex-col ${!selectedWidgets.tasksOverview ? 'opacity-20' : ''}`}>
                    ...
                    <div className={`bg-white border border-[#d0d4e4] rounded-lg p-4 flex flex-col ${!selectedWidgets.tasksOverview ? 'opacity-20' : ''}`}>
                      <div className="flex items-center gap-1.5 mb-3"><span className="w-3 h-3 rounded-full bg-[#00c875]"></span><span className="text-[14px] text-[#676879]">Done</span></div>
                      <div className="h-px bg-[#d0d4e4] mb-3"></div>
                      <span className="text-[24px] font-semibold text-[#323338] leading-none">7</span>
                    </div>
                    <div className={`bg-white border border-[#d0d4e4] rounded-lg p-4 flex flex-col ${!selectedWidgets.tasksOverview ? 'opacity-20' : ''}`}>
                      <div className="flex items-center gap-1.5 mb-3"><span className="w-3 h-3 rounded-full bg-[#fdab3d]"></span><span className="text-[14px] text-[#676879]">Working on it</span></div>
                      <div className="h-px bg-[#d0d4e4] mb-3"></div>
                      <span className="text-[24px] font-semibold text-[#323338] leading-none">5</span>
                    </div>
                    <div className={`bg-white border border-[#d0d4e4] rounded-lg p-4 flex flex-col ${!selectedWidgets.tasksOverview ? 'opacity-20' : ''}`}>
                      <div className="flex items-center gap-1.5 mb-3"><span className="w-3 h-3 rounded-full bg-[#df2f4a]"></span><span className="text-[14px] text-[#676879]">Stuck</span></div>
                      <div className="h-px bg-[#d0d4e4] mb-3"></div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mb-4">
                    {selectedWidgets.tasksByStatus ? (
                      <div className="bg-white border border-[#d0d4e4] rounded-lg p-4">
                        ...
                        <div className="flex items-center justify-center"><img src="https://dapulse-res.cloudinary.com/image/upload/Pie-donut.svg" alt="Tasks by status chart" className="w-full max-w-[130px]" /></div>
                      </div>
                    ) : (<div className="bg-[#ecedf5] rounded-lg h-[200px] border border-[#d0d4e4]"></div>)}
                    ...
                    {selectedWidgets.tasksByOwner ? (
                      <div className="bg-white border border-[#d0d4e4] rounded-lg p-4">
                        ...
                        <div className="h-px bg-[#d0d4e4] mb-4"></div>
                        <div className="flex items-center justify-center"><img src="https://dapulse-res.cloudinary.com/image/upload/tasksByOwnerChart.svg" alt="Tasks by owner chart" className="w-full max-w-[300px]" /></div>
                      </div>
                    ) : (<div className="bg-[#ecedf5] rounded-lg h-[200px] border border-[#d0d4e4]"></div>)}
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    {selectedWidgets.overdueTasks ? (
                      <div className="bg-white border border-[#d0d4e4] rounded-lg p-4">
                        ...
                        <div className="flex items-center justify-center gap-4 py-2">
                          <div className="flex flex-col items-center"><img src="https://dapulse-res.cloudinary.com/image/upload/Bar_5.svg" alt="Working on it bar" className="h-24 mb-2" /><div className="flex items-center gap-1.5"><span className="w-3 h-3 rounded-full bg-[#fdab3d]"></span><span className="text-[14px] text-[#676879]">Working on it</span></div></div>
                          <div className="flex flex-col items-center"><img src="https://dapulse-res.cloudinary.com/image/upload/Bar_6.svg" alt="Stuck bar" className="h-24 mb-2" /><div className="flex items-center gap-1.5"><span className="w-3 h-3 rounded-full bg-[#df2f4a]"></span><span className="text-[14px] text-[#676879]">Stuck</span></div></div>
                        </div>
                      </div>
                    ) : (<div className="bg-[#ecedf5] rounded-lg h-[200px] border border-[#d0d4e4]"></div>)}
                    ...
                    {selectedWidgets.tasksByDueDate ? (
                      <div className="bg-white border border-[#d0d4e4] rounded-lg p-4">
                        ...
                        <div className="h-px bg-[#d0d4e4] mb-4"></div>
                        <div className="relative"><img src="https://dapulse-res.cloudinary.com/image/upload/dashboardBackground.svg" alt="Dashboard background" className="w-full" /><div className="absolute inset-0 grid grid-cols-4 gap-1 items-end justify-center px-4 pb-8"><div className="flex flex-col items-center gap-2"><img src="https://dapulse-res.cloudinary.com/image/upload/Bar_1.svg" alt="Jun bar" className="w-full" style={{ maxHeight: '90px' }} /><span className="text-[14px] text-[#323338]">Jun'</span></div><div className="flex flex-col items-center gap-2"><img src="https://dapulse-res.cloudinary.com/image/upload/Bar_2.svg" alt="Jul bar" className="w-full" style={{ maxHeight: '90px' }} /><span className="text-[14px] text-[#323338]">Jul'</span></div><div className="flex flex-col items-center gap-2"><img src="https://dapulse-res.cloudinary.com/image/upload/Bar_3.svg" alt="Aug bar" className="w-full" style={{ maxHeight: '90px' }} /><span className="text-[14px] text-[#323338]">Aug'</span></div><div className="flex flex-col items-center gap-2"><img src="https://dapulse-res.cloudinary.com/image/upload/Bar_4.svg" alt="Sep bar" className="w-full" style={{ maxHeight: '90px' }} /><span className="text-[14px] text-[#323338]">Sep'</span></div></div></div>
                      </div>
                    ) : (<div className="bg-[#ecedf5] rounded-lg h-[200px] border border-[#d0d4e4]"></div>)}
                  </div>
                </div>
