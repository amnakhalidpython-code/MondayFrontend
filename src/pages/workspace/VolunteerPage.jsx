...
const VolunteerPage = () => {
  ...
  const workspaceInfo = { name: 'Volunteer Registration Management', initial: 'V', color: '#ffcb00', workspaceNumber: workspaceId || '2580952' };
  const boards = [{ name: 'Volunteer registration management' }];
