  ...
  return (
    <div className="w-full min-h-screen bg-white">
      ...
      <div className="w-full relative">
        <img 
          src="https://cdn.monday.com/images/doc-custom-covers/fundraising.jpg" 
          alt="Monday Fundraising Getting Started"
      ...
      <div className="max-w-[900px] mx-auto px-8 py-10">
        ...
        <div className="mb-12">
          ...
          <p className="text-base text-gray-700 mb-6 leading-relaxed">
            ...
            <a href="#" className="text-blue-600 hover:underline font-medium">apply here</a> to get monday.com for FREE.
          </p>
          <div className="w-full bg-gray-100 border border-gray-200 rounded-lg overflow-hidden shadow-md">
            <iframe 
          ...
          <div className="flex gap-8 items-start">
            <div className="w-[40%]">
              <p className="text-base text-gray-700 leading-relaxed">
                ...
                <a href="https://monday.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline font-medium">monday.com</a>.{' '}
                <a href="#" className="text-blue-600 hover:underline font-medium">Read this to learn more</a> on how you can customize them, or watch a 3 minute video.
              </p>
            </div>
            <div className="w-[60%]">
              <div className="w-full bg-gray-100 border border-gray-200 rounded-lg overflow-hidden shadow-md">
          ...
          <div className="flex gap-8 items-start">
            <div className="w-[40%]">
              <p className="text-base text-gray-700 leading-relaxed">
                ...
                <a href="#" className="text-blue-600 hover:underline font-medium">Read this to learn more</a> or watch this short video.
              </p>
            </div>
            <div className="w-[60%]">
              <div className="w-full bg-gray-100 border border-gray-200 rounded-lg overflow-hidden shadow-md">
        ...
        <div className="mb-12">
          ...
          <div className="flex gap-8 items-start">
            <div className="w-[40%]">
              <p className="text-base text-gray-700 leading-relaxed">
                The ability to set up automation in your{' '}
                <a href="https://monday.com" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline font-medium">
                  monday.com
                </a>{' '}
                account is one of our most popular features.{' '}
                <a href="https://support.monday.com/hc/en-us/articles/360001222900-monday-com-Automations" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline font-medium">
        ...
        {/* Call to Action */}
        <div className="mb-12 py-8 px-8 bg-gradient-to-r from-blue-50 to-purple-50 rounded-lg border border-blue-100">
